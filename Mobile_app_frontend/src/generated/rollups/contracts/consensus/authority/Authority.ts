...
export interface AuthorityInterface extends utils.Interface {
  ...
  events: {
    ...
    "ConsensusCreated(address,address)": EventFragment;
    "NewHistory(address)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "ApplicationJoined"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ConsensusCreated"): EventFragment;
...
export interface ConsensusCreatedEventObject {
  owner: string;
  inputBox: string;
}
export type ConsensusCreatedEvent = TypedEvent<
  [string, string],
  ConsensusCreatedEventObject
>;

export type ConsensusCreatedEventFilter =
  TypedEventFilter<ConsensusCreatedEvent>;
