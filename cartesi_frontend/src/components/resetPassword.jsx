...
export default function ResetPassword () {
    ...
    console.log(`user/resetpassword/${location.pathname.split("/")[2]}/${location.pathname.split("/")[3]}/`);
    ...
    const resetPassword = async (event) => {
        try {
            ...
            const response = await axiosInstance.patch(`user/resetpassword/${location.pathname.split("/")[2]}/${location.pathname.split("/")[3]}/`, 
