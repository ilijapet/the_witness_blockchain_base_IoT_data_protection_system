...
export type OutputValidityProof = {
  ...
  keccakInHashesSiblings: Array<Scalars['String']['output']>;
...
export type NoticeQuery = { __typename?: 'Query', notice: { __typename?: 'Notice', index: number, payload: string, input: { __typename?: 'Input', index: number, payload: string }, proof?: { __typename?: 'Proof', context: string, validity: { __typename?: 'OutputValidityProof', inputIndex: number, outputIndex: number, outputHashesRootHash: string, vouchersEpochRootHash: string, noticesEpochRootHash: string, machineStateHash: string, keccakInHashesSiblings: Array<string>, outputHashesInEpochSiblings: Array<string> } } | null } };

export type NoticesQueryVariables = Exact<{ [key: string]: never; }>;


export type NoticesQuery = { __typename?: 'Query', notices: { __typename?: 'NoticeConnection', edges: Array<{ __typename?: 'NoticeEdge', node: { __typename?: 'Notice', index: number, payload: string, input: { __typename?: 'Input', index: number, payload: string } } }> } };
...
export type VoucherQuery = { __typename?: 'Query', voucher: { __typename?: 'Voucher', index: number, destination: string, payload: string, input: { __typename?: 'Input', index: number, payload: string }, proof?: { __typename?: 'Proof', context: string, validity: { __typename?: 'OutputValidityProof', inputIndex: number, outputIndex: number, outputHashesRootHash: string, vouchersEpochRootHash: string, noticesEpochRootHash: string, machineStateHash: string, keccakInHashesSiblings: Array<string>, outputHashesInEpochSiblings: Array<string> } } | null } };

export type VouchersQueryVariables = Exact<{ [key: string]: never; }>;


export type VouchersQuery = { __typename?: 'Query', vouchers: { __typename?: 'VoucherConnection', edges: Array<{ __typename?: 'VoucherEdge', node: { __typename?: 'Voucher', index: number, destination: string, payload: string, input: { __typename?: 'Input', index: number, payload: string } } }> } };
...
export type ReportQuery = { __typename?: 'Query', report: { __typename?: 'Report', index: number, payload: string, input: { __typename?: 'Input', index: number, payload: string } } };

export type ReportsQueryVariables = Exact<{ [key: string]: never; }>;


export type ReportsQuery = { __typename?: 'Query', reports: { __typename?: 'ReportConnection', edges: Array<{ __typename?: 'ReportEdge', node: { __typename?: 'Report', index: number, payload: string, input: { __typename?: 'Input', index: number, payload: string } } }> } };
